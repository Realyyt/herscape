      ...
      <section className="w-full px-6 py-20 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative overflow-hidden rounded-3xl border-2 border-black">
            <div className="p-10">
              <h2 className="text-4xl font-black mb-6">WELCOME TO<br />HERSCAPE</h2>
          ...
          <div className="relative overflow-hidden rounded-3xl">
            <div className="p-10 bg-[#eaffd0] h-full">
              <h2 className="text-4xl font-black mb-6">SUPPORT &<br />INSPIRATION</h2>
              <p className="text-lg text-gray-700">
          ...
          <div className="relative overflow-hidden rounded-3xl">
            ...
            <div className="absolute inset-0 p-10">
              <h2 className="text-4xl font-black mb-6">FOUNDING<br />CIRCLE</h2>
              <p className="text-lg text-gray-700">
          ...
          <div className="relative overflow-hidden rounded-3xl border-2 border-black">
            <div className="p-10">
              <h2 className="text-4xl font-black mb-6">GLOBAL<br />CONNECTION</h2>
              <p className="text-lg text-gray-700">
