    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-[#f7ffe5] via-[#f0f9e8] to-[#e8f5e0] flex flex-col items-center justify-center py-8 sm:py-12 md:py-16 px-3 sm:px-4 relative overflow-hidden">
      ...
      <div className="max-w-5xl w-full mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 lg:p-12 border border-white/20"
        >
          {/* Tier Information */}
          <div className="text-center mb-6 sm:mb-8">
            <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r ${currentTier.color} rounded-full mb-3 sm:mb-4 shadow-lg`}>
              {currentTier.icon}
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-2 text-gray-900">
              {currentTier.name} Membership
            </h2>
            <p className="text-sm sm:text-base text-gray-600">You've selected the perfect tier for your journey</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-4 sm:p-6 border border-blue-200"
            >
              <div className="flex items-center mb-3 sm:mb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full flex items-center justify-center mr-3 sm:mr-4">
              ...
              <div className="bg-white rounded-xl p-4 sm:p-6 border border-blue-200 space-y-2 sm:space-y-3">
                <div className="text-center mb-3 sm:mb-4">
                  <p className="text-xs sm:text-sm text-gray-600 mb-1">Temporary Payment Method</p>
                  <p className="text-xs text-gray-500">(While we await company account approval)</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 sm:gap-x-8 gap-y-4 sm:gap-y-6 text-xs sm:text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {copiedField === 'accountHolder' ? <Check className="w-3 h-3 sm:w-4 sm:h-4 text-green-600" /> : <Copy className="w-3 h-3 sm:w-4 sm:h-4" />}
                    </button>
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <button
                      ...
                      className="ml-2 p-1 text-gray-500 hover:text-blue-600 transition-colors"
                    >
                      {copiedField === 'bankName' ? <Check className="w-3 h-3 sm:w-4 sm:h-4 text-green-600" /> : <Copy className="w-3 h-3 sm:w-4 sm:h-4" />}
                    </button>
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <button
                      ...
                      className="ml-2 p-1 text-gray-500 hover:text-blue-600 transition-colors"
                    >
                      {copiedField === 'accountNumber' ? <Check className="w-3 h-3 sm:w-4 sm:h-4 text-green-600" /> : <Copy className="w-3 h-3 sm:w-4 sm:h-4" />}
                    </button>
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <button
                      ...
                      className="ml-2 p-1 text-gray-500 hover:text-blue-600 transition-colors"
                    >
                      {copiedField === 'routingNumber' ? <Check className="w-3 h-3 sm:w-4 sm:h-4 text-green-600" /> : <Copy className="w-3 h-3 sm:w-4 sm:h-4" />}
                    </button>
                  </div>
                  <div className="md:col-span-2 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="ml-2 p-1 text-gray-500 hover:text-blue-600 transition-colors"
                    >
                      {copiedField === 'accountType' ? <Check className="w-3 h-3 sm:w-4 sm:h-4 text-green-600" /> : <Copy className="w-3 h-3 sm:w-4 sm:h-4" />}
                    </button>
                  </div>
                  <div className="md:col-span-2 flex items-center justify-between">
                    <div>
                    ...
                    <button
                      ...
                      className="ml-2 p-1 text-gray-500 hover:text-blue-600 transition-colors"
                    >
                      {copiedField === 'address' ? <Check className="w-3 h-3 sm:w-4 sm:h-4 text-green-600" /> : <Copy className="w-3 h-3 sm:w-4 sm:h-4" />}
                    </button>
                  </div>
                </div>
                <div className="mt-3 sm:mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <button
                    ...
                    className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg text-xs sm:text-sm font-medium hover:bg-blue-700 transition-colors flex items-center justify-center"
                  >
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-4 sm:p-6 border border-green-200 flex flex-col space-y-3 sm:space-y-4"
            >
              <div className="flex items-center">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-green-400 to-green-600 rounded-full flex items-center justify-center mr-3 sm:mr-4">
                  <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900">Email Confirmation Sent</h3>
              </div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-[#bdda57]/10 to-[#bdda57]/5 rounded-2xl p-4 sm:p-6 border border-[#bdda57]/20"
          >
            <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-900 text-center">Your {currentTier.name} Benefits</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
              {currentTier.benefits.map((benefit, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-xl p-3 sm:p-4 border border-[#bdda57]/20 text-center"
                >
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-[#bdda57] rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
        ...
        >
          <Link
            to="/"
            className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#bdda57] to-[#a8c94a] text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 text-sm sm:text-base"
          >
          ...
          <Link
            to="/join"
            className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-white text-gray-900 font-bold rounded-full border-2 border-[#bdda57] shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 text-sm sm:text-base"
          >
            Apply Again
          </Link>
        </motion.div>
