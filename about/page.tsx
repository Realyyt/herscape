...
<div className="flex-1 flex flex-col justify-center items-end text-right gap-4">
  ...
  <a href="#donate" className="inline-block bg-white text-pink-500 px-8 py-3 rounded-full text-lg font-semibold hover:bg-pink-50 transition-all duration-300 border-2 border-pink-500 hover:border-pink-600 hover:text-pink-600">Support the Herscape Women's Fund</a>
